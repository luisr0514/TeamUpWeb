...
class Pagos extends StatefulWidget {
  ...
  @override
  State<Pagos> createState() => _Pagos();
}
...
class _Pagos extends State<Pagos> {
  ...
  void _showUser; DetailsDialog(UserModel user) {
    showDialog(
      context: context,
...
void _showPaymentHistoryDialog(String userId) {
  showDialog(
    context: context,
    builder: (BuildContext context) {
      return AlertDialog(
          ...
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              if (snapshot.hasError) {
                return Center(child: Text('Error al cargar pagos: ${snapshot.error}'));
              }
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final paymentDate = (paymentData['createdAt'] as Timestamp).toDate();
                  final amount = paymentData['amount'] ?? 0.0;
                  final status = paymentData['status'] ?? 'Desconocido';
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextButton(
                                    onPressed: () {
                                      _showPaymentHistoryDialog(user.uid); // Cambiado para pasar el ID del usuario
                                    },
                                    style: TextButton.styleFrom(
                                      foregroundColor: Colors.white,
                                      backgroundColor: const Color.fromARGB(255, 77, 166, 255),
                                      shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(12.0),
                                      ),
